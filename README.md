...
Minimal Python, Node.js, and cURL examples for testing APIVAI's OpenAI-compatible API.
    ...
    API base URL (default): https://tmbot.asia/
...
Before running examples, make sure you have:
    ...
    Network access to https://tmbot.asia/
    One of:
